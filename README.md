...
To learn to use the language, or to force an AI to use it read [CEJBSBDSL.spec.md](CEJBSBDSL.spec.md). You are free to make your own projects in it! Although I would not wish that on my worst enemy.
